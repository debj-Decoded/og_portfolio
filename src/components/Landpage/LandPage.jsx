          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-gray-400 text-lg max-w-lg leading-relaxed">
                I'm a passionate full stack developer crafting seamless digital experiences from front-end finesse to back-end power. I build scalable, user-centric web applications.
              </p>
            </div>
            ...
            <div className="flex gap-4 pt-4">
              {[AiFillLinkedin, AiFillGithub, AiFillInstagram].map((Icon, index) => (
                <motion.a
                  key={index}
                  href="#"
